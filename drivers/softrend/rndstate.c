 ...
 */
br_error BR_CMETHOD_DECL(br_renderer_soft, partSet)(struct br_renderer* self, br_token part, br_int_32 index, br_token t, br_value value) {
    br_error r;
...
br_error BR_CMETHOD_DECL(br_renderer_soft, partSetMany)(struct br_renderer* self, br_token part, br_int_32 index, br_token_value* tv, br_int_32* pcount) {
    br_error r;
    struct state_all* sp = &self->state;
    struct br_tv_template* tp = FindStateTemplate(self, &sp, part, index);
    br_uint_32 m = 0;
 ...
 */
br_error BR_CMETHOD_DECL(br_renderer_soft, partQuery)(struct br_renderer* self, br_token part, br_int_32 index, void* pvalue, br_token t) {
    br_error r;
    struct state_all* sp = &self->state;
    struct br_tv_template* tp = FindStateTemplate(self, &sp, part, index);
...
br_error BR_CMETHOD_DECL(br_renderer_soft, partQueryBuffer)(struct br_renderer* self, br_token part, br_int_32 index, void* pvalue, void* buffer, br_size_t buffer_size, br_token t) {
    br_error r;
    struct state_all* sp = &self->state;
    struct br_tv_template* tp = FindStateTemplate(self, &sp, part, index);
...
br_error BR_CMETHOD_DECL(br_renderer_soft, partQueryManySize)(struct br_renderer* self, br_token part, br_int_32 index, br_size_t* pextra_size, br_token_value* tv) {
    br_error r;
    struct state_all* sp = &self->state;
    struct br_tv_template* tp = FindStateTemplate(self, &sp, part, index);
...
br_error BR_CMETHOD_DECL(br_renderer_soft, partQueryAll)(struct br_renderer* self, br_token part, br_int_32 index, br_token_value* buffer, br_size_t buffer_size) {
    br_error r;
    struct state_all* sp = &self->state;
    struct br_tv_template* tp = FindStateTemplate(self, &sp, part, index);
...
br_error BR_CMETHOD_DECL(br_renderer_soft, partQueryAllSize)(struct br_renderer* self, br_token part, br_int_32 index, br_size_t* psize) {
    br_error r;
    struct state_all* sp = &self->state;
    struct br_tv_template* tp = FindStateTemplate(self, &sp, part, index);
...
#if BASED_FIXED
br_error BR_CMETHOD_DECL(br_renderer_soft, boundsTestF)(struct br_renderer* self, br_token* r, br_bounds3_f* bounds_in)
#define BOUNDS_CONV(a, b) convertBounds3FloatToFixed((struct br_bounds3_x*)(a), (struct br_bounds3_f*)(b))
#endif
#if BASED_FLOAT
    br_error BR_CMETHOD_DECL(br_renderer_soft, boundsTestX)(struct br_renderer* self, br_token* r, br_bounds3_x* bounds_in)
...
br_error BR_CMETHOD_DECL(br_renderer_soft, stateSave)(struct br_renderer* self, struct br_renderer_state_stored* save, br_uint_32 mask) {
    return StateCopyToStored(save, &self->state, mask, save);
}

br_error BR_CMETHOD_DECL(br_renderer_soft, stateRestore)(struct br_renderer* self, struct br_renderer_state_stored* save, br_uint_32 mask) {
    /*
     * Remember the state
     */
