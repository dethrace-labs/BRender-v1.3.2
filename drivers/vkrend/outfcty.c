...
static struct br_tv_template* BR_CMETHOD_DECL(br_output_facility_vk, queryTemplate)(br_object* _self) {
    br_output_facility* self = (br_output_facility*)_self;
...
static br_error BR_CMETHOD_DECL(br_output_facility_vk, pixelmapNew)(br_output_facility* self,
    br_device_pixelmap** ppmap, br_token_value* tv) {
    br_device_pixelmap* pm;

    pm = DevicePixelmapVKAllocateFront(self->device, self, tv);
...
static br_error BR_CMETHOD_DECL(br_output_facility_vk, clutNew)(br_output_facility* self, br_device_clut** pclut,
    br_token_value* tv) {
    (void)self;
    (void)pclut;
    (void)tv;
...
static void* BR_CMETHOD_DECL(br_output_facility_vk, listQuery)(struct br_object_container* self) {
