...
br_renderer_facility* RendererFacilityVKInit(br_device* device) {
    ...
    if (GeometryPrimitivesNullAllocate(self, "Primitives") == NULL ||
        GeometryLightingNullAllocate(self, "Lighting") == NULL ||
        GeometryV1ModelVKAllocate(self, "V1Model") == NULL) {
...
static struct br_device* BR_CMETHOD_DECL(br_renderer_facility_vk, device)(br_object* self) {
...
static struct br_tv_template* BR_CMETHOD_DECL(br_renderer_facility_vk, templateQuery)(br_object* _self) {
    br_renderer_facility* self = (br_renderer_facility*)_self;
...
static br_error BR_CMETHOD_DECL(br_renderer_facility_vk, validDestination)(br_renderer_facility* self, br_boolean* bp,
    br_object* h) {
    (void)self;
    (void)bp;
    (void)h;
...
static br_error BR_CMETHOD_DECL(br_renderer_facility_vk, rendererNew)(br_renderer_facility* self,
    ...
    renderer = RendererVKAllocate(self->device, self, (br_device_pixelmap*)rt.dest);
