...
static const struct br_geometry_lighting_dispatch geometryLightingDispatch = {
    ...
    NULL,                                                   // .__reserved2
    NULL,                                                   // .__reserved3
    BR_CMETHOD_REF(br_geometry_lighting_null, free),        // ._free
    BR_CMETHOD_REF(br_geometry_lighting_null, identifier),  // ._identifier
    BR_CMETHOD_REF(br_geometry_lighting_null, type),        // ._type
    BR_CMETHOD_REF(br_geometry_lighting_null, isType),      // ._isType
    BR_CMETHOD_REF(br_geometry_lighting_null, device),      // ._device
    BR_CMETHOD_REF(br_geometry_lighting_null, space),       // ._space

    BR_CMETHOD_REF(br_geometry_lighting_null, templateQuery), // ._templateQuery
    ...
    BR_CMETHOD_REF(br_geometry_lighting_null, render),        // ._renderF
};
