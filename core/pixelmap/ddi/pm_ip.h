...
br_error BR_CMETHOD_DECL(br_device_pixelmap_mem, validSource)(struct br_device_pixelmap* self, br_object* h);
...
br_error BR_CMETHOD_DECL(br_device_pixelmap_mem, allocateSub)(struct br_device_pixelmap* self, struct br_device_pixelmap** newpm, br_rectangle* rect);
...
br_error BR_CMETHOD_DECL(br_device_pixelmap_mem, copyDirty)(struct br_device_pixelmap* self, struct br_device_pixelmap* src, br_rectangle* dirty, br_int_32 num_rects);
br_error BR_CMETHOD_DECL(br_device_pixelmap_mem, copyToDirty)(struct br_device_pixelmap* self, struct br_device_pixelmap* src, br_rectangle* dirty, br_int_32 num_rects);
br_error BR_CMETHOD_DECL(br_device_pixelmap_mem, copyFromDirty)(struct br_device_pixelmap* self, struct br_device_pixelmap* src, br_rectangle* dirty, br_int_32 num_rects);
br_error BR_CMETHOD_DECL(br_device_pixelmap_mem, fillDirty)(struct br_device_pixelmap* self, br_uint_32 colour, br_rectangle* dirty, br_int_32 num_rects);
br_error BR_CMETHOD_DECL(br_device_pixelmap_mem, doubleBufferDirty)(struct br_device_pixelmap* self, struct br_device_pixelmap* src, br_rectangle* dirty, br_int_32 num_rects);
...
br_error BR_CMETHOD_DECL(br_device_pixelmap_mem, rectangle2)(struct br_device_pixelmap* self, br_rectangle* rect, br_uint_32 colour_tl, br_uint_32 colour_br);

br_error BR_CMETHOD_DECL(br_device_pixelmap_mem, rectangleCopyTo)(struct br_device_pixelmap* self, br_point* p, struct br_device_pixelmap* mem, br_rectangle* r);
br_error BR_CMETHOD_DECL(br_device_pixelmap_mem, rectangleCopyFrom)(struct br_device_pixelmap* self, br_point* p, struct br_device_pixelmap* mem, br_rectangle* r);

br_error BR_CMETHOD_DECL(br_device_pixelmap_mem, rectangleStretchCopyTo)(struct br_device_pixelmap* self, br_rectangle* d, struct br_device_pixelmap* mem, br_rectangle* s);
br_error BR_CMETHOD_DECL(br_device_pixelmap_mem, rectangleStretchCopyFrom)(struct br_device_pixelmap* self, br_rectangle* d, struct br_device_pixelmap* mem, br_rectangle* s);
...
br_error BR_CMETHOD_DECL(br_device_pixelmap_mem, pixelAddressQuery)(struct br_device_pixelmap* self, void** pptr, br_uint_32* pqual, br_point* point);
...
br_error BR_CMETHOD_DECL(br_device_pixelmap_gen, copyDirty)(struct br_device_pixelmap* self, struct br_device_pixelmap* src, br_rectangle* dirty, br_int_32 num_rects);
br_error BR_CMETHOD_DECL(br_device_pixelmap_gen, copyToDirty)(struct br_device_pixelmap* self, struct br_device_pixelmap* src, br_rectangle* dirty, br_int_32 num_rects);
br_error BR_CMETHOD_DECL(br_device_pixelmap_gen, copyFromDirty)(struct br_device_pixelmap* self, struct br_device_pixelmap* src, br_rectangle* dirty, br_int_32 num_rects);
br_error BR_CMETHOD_DECL(br_device_pixelmap_gen, fillDirty)(struct br_device_pixelmap* self, br_uint_32 colour, br_rectangle* dirty, br_int_32 num_rects);
br_error BR_CMETHOD_DECL(br_device_pixelmap_gen, doubleBufferDirty)(struct br_device_pixelmap* self, struct br_device_pixelmap* src, br_rectangle* dirty, br_int_32 num_rects);
...
br_error BR_CMETHOD_DECL(br_device_pixelmap_gen, rectangle2)(struct br_device_pixelmap* self, br_rectangle* rect, br_uint_32 colour_tl, br_uint_32 colour_br);
...
br_error BR_CMETHOD_DECL(br_device_pixelmap_null, copyDirty)(struct br_device_pixelmap* self, struct br_device_pixelmap* src, br_rectangle* dirty, br_int_32 num_rects);
br_error BR_CMETHOD_DECL(br_device_pixelmap_null, copyToDirty)(struct br_device_pixelmap* self, struct br_device_pixelmap* src, br_rectangle* dirty, br_int_32 num_rects);
br_error BR_CMETHOD_DECL(br_device_pixelmap_null, copyFromDirty)(struct br_device_pixelmap* self, struct br_device_pixelmap* src, br_rectangle* dirty, br_int_32 num_rects);
br_error BR_CMETHOD_DECL(br_device_pixelmap_null, fillDirty)(struct br_device_pixelmap* self, br_uint_32 colour, br_rectangle* dirty, br_int_32 num_rects);
br_error BR_CMETHOD_DECL(br_device_pixelmap_null, doubleBufferDirty)(struct br_device_pixelmap* self, struct br_device_pixelmap* src, br_rectangle* dirty, br_int_32 num_rects);
br_error BR_CMETHOD_DECL(br_device_pixelmap_null, rectangleCopyTo)(struct br_device_pixelmap* self, br_point* p, struct br_device_pixelmap* src, br_rectangle* r);
br_error BR_CMETHOD_DECL(br_device_pixelmap_null, rectangleCopyFrom)(struct br_device_pixelmap* self, br_point* p, struct br_device_pixelmap* mem, br_rectangle* r);
br_error BR_CMETHOD_DECL(br_device_pixelmap_null, rectangleStretchCopyTo)(struct br_device_pixelmap* self, br_rectangle* d, struct br_device_pixelmap* mem, br_rectangle* s);
br_error BR_CMETHOD_DECL(br_device_pixelmap_null, rectangleStretchCopyFrom)(struct br_device_pixelmap* self, br_rectangle* d, struct br_device_pixelmap* mem, br_rectangle* s);
